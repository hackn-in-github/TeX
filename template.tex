...
%\setmonofont{MogaGo}
\setmainjfont[BoldFont=Source Han Serif JP Bold]{Source Han Serif JP Light}
\setsansjfont[BoldFont=Source Han Sans JP Bold]{Source Han Sans JP Light}
\setmonofont{Source Code Pro JP Light}

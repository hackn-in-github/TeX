...
%#!lualatex --jobname=前期/filename-fig1 filename
...
%\documentclass[a4j,papersize,xelatex,ja=standard,magstyle=nomag*]{bxjsreport}% ドライバ指定は無し
...
\documentclass[a4j,papersize,lualatex,ja=standard,magstyle=nomag*]{bxjsreport}% ドライバ指定は無し
